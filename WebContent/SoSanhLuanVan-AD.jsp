...
<body>
  ...
  <div class="col-xs-6 col-sm-3">
  <h4>Luận văn 1</h4>
     <textarea name="textarea1" style="width:250px;height:200px;" disabled="true"></textarea>
     <div class="input-group">
      <input type="text" class="form-control" placeholder="Mã đề tài" >
      <span class="input-group-btn">
        <button class="btn btn-default" type="button">Chọn</button>
      </span>
    </div>
  </div>
  ...
  <div class="col-xs-6 col-sm-3">
  <h4>Luận văn 2</h4>
     <textarea name="textarea2" style="width:250px;height:200px;" disabled="true"></textarea>
     <div class="input-group">
      <input type="text" class="form-control" placeholder="Mã đề tài" >
      <span class="input-group-btn">
        <button class="btn btn-default" type="button">Chọn</button>
  ...
  <div class="col-xs-6 col-sm-3">
    ...
    <div class="input-group">
      ...
      <span class="input-group-btn">
        <button class="btn btn-default" type="button">So sánh</button>
      </span>
    </div>
    <br>
  <p>
    Kết quả % được dựa trên phần nội dung tóm tắt của từng luận văn.
  </p>
