...
<div id="openDoiMK" class="modalDialog">
        		...
        		<a href="#close" title="Close" class="close">X</a>
        			<form action="DoiMK.jsp">
        				 	
						  <h2 id="dn">Đổi mật khẩu</h2>
				 		<input id="input1" placeholder="Tên truy cập" type="text" required="" name="uname">
						 <input id="input2" placeholder="Mật khẩu cũ" type="password" required="" name="opass">
						 <input id="input2" placeholder="Mật khẩu mới" type="password" required="" name="npass">
						 <input id="input2" placeholder="Nhập lại" type="password" required="" name="nnpass">
